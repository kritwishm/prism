...
export const metadata: Metadata = {
  title: "CertifyOS — Provider data infrastructure",
  description:
    "API-first credentialing, licensing, and provider network monitoring. Built for health plans and digital health.",
};
